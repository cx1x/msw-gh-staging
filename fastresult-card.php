					...
					<header class="container-fluid header-container">
						...
						<div class="row">
							...
							<div class="col-xs-4">
								...
								<a href="<?php echo $folder; ?>/fastresult-track/<?=$_trackID;?>/<?=$_date;?>" data-type="page-transition" style="color: #fff;">
												...
												foreach($_race_time AS $_k => $_v){
													...
													if($_v->race_uid == $_raceID){
														...
														if(get_next_fastresult_raceid($_trackID, $_v->race_time, $_v->track_date, 'less') == '#'){
															...
															<a class="left carousel-control" href="'. $folder .'/fastresult-card/'.$_trackID.'/'.get_next_fastresult_raceid($_trackID, $_v->race_time, $_v->track_date, 'less').'/'.$_v->track_date.'" data-slide="prev" data-type="page-transition">
														...
														if(get_next_fastresult_raceid($_trackID, $_v->race_time, $_v->track_date, 'greater') == '#'){
															...
															<a class="right carousel-control" href="'. $folder .'/fastresult-card/'.$_trackID.'/'.get_next_fastresult_raceid($_trackID, $_v->race_time, $_v->track_date, 'greater').'/'.$_v->track_date.'" data-slide="next" data-type="page-transition">
