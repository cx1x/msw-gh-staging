				...
				<header class="container-fluid header-container head-orange">
					...
					<div class="row">
						...
						<div class="col-xs-4">
							...
							<a href="<?php echo $folder ?>/card/<?=$_datas->dog_details->race_group;?>/<?=$_raceid;?>/<?=$_date;?>" data-type="page-transition">
						...
						<div class="col-xs-4 text-center">
							...
							<strong class="head-title pull-right fs-14">
								...
								<a href="<?php echo $folder ?>/dogs/<?=$_track;?>/<?=$_raceid;?>/<?=$_date;?>/<?=get_next_dog($_raceid, $_datas->dog_details->trap, 'prev');?>" data-type="page-transition"><i class="fa fa-angle-up fa-2x"></i></a>
								
								&nbsp;&nbsp;
								
								<a href="<?php echo $folder ?>/dogs/<?=$_track;?>/<?=$_raceid;?>/<?=$_date;?>/<?=get_next_dog($_raceid, $_datas->dog_details->trap, 'next');?>" data-type="page-transition"><i class="fa fa-angle-down fa-2x"></i></a>
